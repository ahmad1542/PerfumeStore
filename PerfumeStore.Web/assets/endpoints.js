window.API_ENDPOINTS = {
  ...
  products: `${window.APP_CONFIG.API_BASE_URL}/Products`,
  inventory: `${window.APP_CONFIG.API_BASE_URL}/Inventory`,
  debts: `${window.APP_CONFIG.API_BASE_URL}/Debts`,
  salesInvoices: `${window.APP_CONFIG.API_BASE_URL}/SalesInvoices`,
  purchaseInvoices: `${window.APP_CONFIG.API_BASE_URL}/PurchaseInvoices`,
  expenses: `${window.APP_CONFIG.API_BASE_URL}/Expenses`,
  expenseTypes: `${window.APP_CONFIG.API_BASE_URL}/ExpenseTypes`,
